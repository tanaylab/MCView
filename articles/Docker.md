...
**MCView** maintains a docker image with all the R and python
dependencies. By default, the image starts an app with the project
mounted at `/project` in the docker fs, but you can also use it to
create projects or import datasets.
