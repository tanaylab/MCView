...
We can edit some of the parameters if we want, see the [config](https://tanaylab.github.io/MCview/articles/config.html) vignette for a full description of the config parameters. 
