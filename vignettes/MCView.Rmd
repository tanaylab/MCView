...
The configuration file was generated using `create_project` paramters, but we can edit them if we want, or add parameters per dataset, see the [architecture](https://tanaylab.github.io/MCView/articles/Architecture.html) vignette for a full description of the config parameters. 
