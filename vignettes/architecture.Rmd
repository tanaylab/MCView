...
```yaml
["Manifold", "Genes", "Metacells", "Annotate", "About"]
```
...
Additional per-dataset parameters. This is currently a bit degenerated but would include more parameters in the future. 
...
The bundle can then be deployed in shiny-server, [shinyapps.io](https://docs.rstudio.com/shinyapps.io/getting-started.html#deploying-applications) or any other environment that supports serving shiny apps. 
