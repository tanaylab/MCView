...
A project is a standard library structure that binds config and data, e.g.: 
...
The above example shows the directory structure of a project named `my_project` that contains two metacell datasets - wt and ko. Multiple functions in the __MCView__ package would accept the project path and would expect to find the configuration files and data in the standard relative path. 
...
The cached files would be saved under the data section in the project folder, in a separate folder for each dataset. In the above example: 
