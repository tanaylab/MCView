...
create_project_config_file <- function(project_dir,
    ...
    if (is.null(tabs)) {
        if (atlas) {
            tabs <- c("QC", "Manifold", "Genes", "Query", "Atlas", "Markers", "Gene modules", "Projected-fold", "Diff. Expression", "Cell types", "Annotate", "About")
        } else {
