...
setup_samples_de <- function(input, output, session, ns,
                             ...
                             gene_modules, group_field, state) {
    ...
    output$plot_samp_samp_gene_scatter <- render_mc_mc_gene_plotly(input, output, session, ns, dataset, state, gene_modules, samp_samp_scatter_df, metacell_names, cell_type_colors, mode = "Samples", tab_guard = "samples")
    ...
    output$plot_group_comparison_scatter <- render_mc_mc_gene_plotly(
        input, output, session, ns, dataset, state, gene_modules,
