...
compute_umap <- function(mc_egc, anchors, min_dist = 0.96, n_neighbors = 10, n_epoch = 500, min_log_expr = -14, genes_per_anchor = 30, random_seed = 60427, config = NULL) {
    ...
    legc <- as.matrix(jlview::jlview_log2p(mc_egc, 1e-5))
...
# ==============================================================================
# UMAP and Layout Utilities
# ==============================================================================

#' Convert layout and graph to mc2d format
#'
#' @param layout Layout data frame
#' @param graph Graph data frame
#' @param metacells Vector of metacell IDs
#' @param warn_function Warning function
#' @param error_function Error function
#' @return mc2d list
#' @noRd
