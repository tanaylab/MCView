...
adata_full <- anndata::read_h5ad("../full.h5ad")
...
metadata <- cell_metadata_to_metacell_from_h5ad("../cells.h5ad", c("batch"), categorical = TRUE)

adata <- anndata::read_h5ad("../cells.h5ad")
